...
define([
    ...
    return angular.module('ui.bootstrap.tabs', [])
     ...
     */
        .directive('tabset', function() {
            return {
                ...
                templateUrl: 'components/bootstrap-ui/template/tabs/tabset.html',
        ...
        .directive('tab', ['$parse', '$http', '$templateCache', '$compile',
            function($parse, $http, $templateCache, $compile) {
                return {
                    ...
                    restrict: 'EA',
                    replace: true,
                    templateUrl: 'components/bootstrap-ui/template/tabs/tab.html',
                    transclude: true,
                    scope: {
                        heading: '@',
